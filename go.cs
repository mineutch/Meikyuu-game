...
public class go : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (q != 0)
        {
            transform.position += new Vector3(0,speed * q * Time.deltaTime,0);
        ...
        if (w == 1)
        {
            ...
            if(direction!=5)
                ...
                transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler((direction % 4) * 90f,0, 0), step);
        }
